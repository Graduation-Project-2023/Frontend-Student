    ...
    We aim to offer our students value, knowledge, and scientific power to make a positive change in the world. No matter what your scope of study is, your major subject or interest might be, you will find the right program for you, as SCU has 20 faculties operating on its campus.
      ...
      <div className="seecond-container">
        <h3 className="seecond-container-title">
          ...
          <li>The student must hold a bachelor's degree from one of the universities recognized by the supreme council of universities.</li>
          <li>The student must meet the conditions of admission as well as the department's approval.</li>
          <li>The student must submit a hard copy of the required documents at the administration's building and then submit a soft copy through the admission from on the website.</li>
          <li>The student selects the appropriate courses and updates the registration form, then passes it to the academic advisor and the head of the specialized scientific department for accreditation. Eventually, the vice dean for postgraduate studies and research approves of the form.</li>
          <li>If the student meets the admission criteria, he/she will not be admitted until the tuition fees are paid.</li>
          <li>Payment of tuition fees is a must for the student to be allowed to attend and record courses.</li>
          <li>A student who still has not selected his/her courses of study after the last week of the spring semester and the first week of the summer semester will not be allowed to attend lectures.</li>
          <li>The institute/faculty council may, on the recommendation of the department council, accept the registration of a student who holds a bachelor's degree in a specialization not related to the department after passing several supplementary courses at the Bachelor level established by the competent section board.</li>
          <li>If the number of the assigned courses exceeds four, the institute/faculty will offer the student a preparatory year for qualification. The year will not be counted among the official years of study.</li>
        </ul>
      </div>
      <div className="thhird-container">
      <h3 className="thhird-container-title">
            Required Documents  
          </h3>
          <ol className="thhird-container-text">
          ...
          <li>Tuition fees.</li>
          <li>Registration in the diploma will only be accepted after fulfilling the conditions and documents mentioned.</li>
        </ol>
      </div>
      </div>
    )
