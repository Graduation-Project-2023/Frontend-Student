  ...
  return (
    <>
      ...
      <div className="aboutUs">
        ...
        <p className="aboutUs-text">{t("home.aboutUsDescription")}</p>
      ...
      <div className="home-container">
        ...
        <div className="home-container-grid">
          <div className="home-container-grid-news">
            ...
            <button className="home-container-grid-news-btn">
              {t("home.more")}
            </button>
          </div>
          ...
          <div className="home-container-grid-news">
            ...
            <h4 className="home-container-grid-news-title">{t("home.HR")}</h4>
            <h6 className="home-container-grid-news-content">
              {t("home.HRNews")}
            </h6>
            <button className="home-container-grid-news-btn">
      ...
      <div className="latestNews">
        ...
        <div className="latestNews-container">
          ...
          <h6 className="latestNews-container-news">{t("home.news")}</h6>
