export const StudentInfoData = [
  {
    ...
    data: [
      ...
      { id: 6, title: "common.birthdate", name: "birthDate" },
  ...
  },
  {
    ...
    data: [
      ...
      { id: 3, title: "common.enrollmentYear", name: "enrollmentYear" },
      { id: 4, title: "common.enrollmentEndDate", name: "enrollmentEndDate" },
      {
        id: 5,
